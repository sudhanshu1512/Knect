...
const CommentDialog = ({ open, setOpen }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-[90%] max-w-3xl h-[90vh] p-0 gap-0">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-3">
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <span 
                    className="font-medium text-sm sm:text-base mr-2 cursor-pointer hover:underline"
                    onClick={() => {
                      setOpen(false);
                      navigate(`/profile/${selectedPost?.author?._id}`);
                    }}
                  ...
                  <span className="text-sm sm:text-base">{selectedPost?.caption}</span>
                </div>
              </div>
